...
- 团队：马其瑞、孙雨瑶、居欣月（专业/年级/分工见第五部分，待最终确认）
- 版本：2.0（AIC 参赛版）
...
协作上用 Git 做版本控制（main 保护分支 + PR 审核），任务看板管理进度，每周例会同步。跨专业协作的价值在于：计算机成员负责算法与平台，电子信息成员把关电路/嵌入式实验内容的学科正确性，两边交叉验证"AI 技术 × 学科场景"的贴合度——这也正是本赛道"避免技术与学科场景脱节"要求下的组织保障。
