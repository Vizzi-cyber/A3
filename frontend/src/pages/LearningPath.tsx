...
import { StatusTag, statusColors, statusBg, statusLabels } from '../components/StatusTag'
                    ...
                    return (
                      <div key={node.id} className={`relative flex items-start gap-4 md:gap-8 ${isLeft ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                        ...
                        <div className="relative z-10 shrink-0">
                          ...
                          >
                            <StatusIcon status={node.status} pendingIcon={<span className="text-xs font-bold">{idx + 1}</span>} />
                          </div>
                        </div>
                        {/* 内容卡片 */}
