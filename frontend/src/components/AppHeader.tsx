        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div className="hidden md:block relative" ref={searchRef}>
            ...
            <Input
              ...
              onPressEnter={() =>
                searchResults[0] && handleSelectResult(searchResults[0])
              }
            />
            {searchOpen && (
      ...
      >
        <div className="space-y-4 text-slate-600 text-sm leading-relaxed">
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
            ...
            <p>
              2.
              在「学习中心」选择左侧目录中的知识点，查看图文讲义、代码示例和练习题。
            </p>
            <p>
              3. 遇到不懂的问题，随时打开「智能辅导」向 AI
              助手提问，支持发送图片。
            </p>
          </div>
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
            ...
            <p>
              • 代码编辑器：可编辑 Python 代码，点击「运行代码」查看执行结果
            </p>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
            ...
            <p>
              系统会根据你的画像自动生成个性化学习路径。你可以在「学习路径」页面查看进度，点击节点查看详情，或调整路径偏好。
            </p>
          </div>
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
            <p className="font-semibold text-slate-800 mb-2">👤 个人空间</p>
            <p>
              查看学习历史趋势、收藏夹资源和画像详情。系统会根据你的学习行为持续优化推荐内容。
            </p>
          </div>
